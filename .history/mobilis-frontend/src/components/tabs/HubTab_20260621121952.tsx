...
interface HubTabProps {
    ...
    setAppNetwork: React.Dispatch<React.SetStateAction<'TESTNET' | 'PUBLIC'>>;
}

const HubTab: React.FC<HubTabProps> = ({ stellarData, isAdmin, currencyMode, setCurrencyMode, formatCurrency, debtState, isProcessing, handleRequestAdvance, handleSettleLoan, appNetwork, setAppNetwork }) => {
        ...
        <div className="w-full flex flex-col items-center">
            <div className="w-full max-w-lg mb-4 flex justify-between items-center">
                ...
                {isAdmin ? (
                    <select
                        value={appNetwork}
                        onChange={(e) => setAppNetwork(e.target.value as 'TESTNET' | 'PUBLIC')}
