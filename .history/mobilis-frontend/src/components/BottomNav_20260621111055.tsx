...
const BottomNav: React.FC<BottomNavProps> = ({ activeTab, setActiveTab, role }) => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 dark:bg-[#0a0a14]/90 backdrop-blur-xl border-t border-gray-200 dark:border-white/10 pb-safe transition-colors duration-300">
