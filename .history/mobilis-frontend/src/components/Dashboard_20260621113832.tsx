...
const Dashboard: React.FC = () => {
    ...
    const activePubKey = externalWallet || stellarData?.publicKey; // Prioritize external wallet if connected
    ...
    useEffect(() => {
        const fetchLedgerData = async () => {
            ...
            try {
                ...
                // Fetch History (Shows for ALL users)
            ...
            // Fetch Contract Debt (Only for drivers)
    ...
    const handleConnectWallet = async () => {
        if (await isInstalled()) {
            try {
                ...
                if (publicKey) setExternalWallet(publicKey);
            } catch (e) {
                alert("Connection request was rejected by the wallet.");
            }
        } else {
