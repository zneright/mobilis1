    ...
    import { collection, query, where, getDocs, doc, updateDoc, addDoc } from 'firebase/firestore'; // Added addDoc
    import {
        Keypair,
        Networks,
        TransactionBuilder,
    ...
    const Dashboard: React.FC = () => {
        ...
        // We now have a dedicated state for Firebase History
        ...
        }, [activePubKey, isProcessing, stellarData?.role, appNetwork]); // Re-runs if network changes
        ...
        const handleSendXLM = async (e: React.FormEvent) => {
            ...
            // 1. Pre-Transaction Balance Checker
            ...
            try {
                ...
                // 2. Wait for Ledger Confirmation
                ...
                if (txResult.status === "SUCCESS") {
                    // 3. Log Rich Metadata to Firebase History
                ...
                alert("Failed to send funds. Check destination address and ensure you have enough XLM for fees.");
            ...
            <div className="flex h-screen bg-gray-50 dark:bg-[#060610] text-gray-900 dark:text-white font-sans overflow-hidden">
                ...
                <div className="flex-1 flex flex-col h-full overflow-y-auto relative">
                    ...
                    <main className="flex-1 w-full max-w-6xl mx-auto p-4 sm:p-8 flex flex-col items-center pb-32 md:pb-8">
                        ...
                        {/* Pass the new Firebase History to the History Tab */}
