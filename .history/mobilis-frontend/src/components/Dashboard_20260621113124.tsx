...
const Dashboard: React.FC = () => {
    ...
    const handleConnectWallet = async () => {
        if (await isInstalled()) {
            try {
                // requestAccess forces the Freighter popup to appear
            ...
            alert("Freighter is not installed. Please install the browser extension or open this app inside a Web3 mobile browser (like Lobstr).");
        }
    };
