...
import { Eye, EyeOff, Copy, AlertTriangle, ArrowDownLeft, ArrowUpRight, Banknote, RefreshCw, Link as LinkIcon, Unlink } from 'lucide-react';
...
const VaultTab: React.FC<VaultTabProps> = ({ stellarData, externalWallet, activePubKey, xlmBalance, assetBalances, currencyMode, setCurrencyMode, formatCurrency, setShowWalletModal, handleDisconnectWallet, setShowReceiveModal, setShowSendModal }) => {
